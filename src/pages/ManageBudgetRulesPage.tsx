...
export default function ManageBudgetRulesPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        {" "}
        <h1 className="text-3xl font-semibold text-slate-100"> Budget Rules & Automation </h1>{" "}
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-semibold text-slate-100"> {targetName(rule)} </h3>{" "}
                    {!rule.enabled && (
                  ...
                  <div className="mt-1 text-sm text-slate-400">
                    {" "}
                    Flag if spend exceeds ₹ {rule.thresholdAmount.toLocaleString("en-IN")} per{" "}
                    {rule.period.replace("ly", "")} {rule.note ? ` · ${rule.note}` : ""}{" "}
                  </div>{" "}
                </div>{" "}
                <div className="flex items-center gap-2">
                  {" "}
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-slate-100"> Auto-Categorize Rules </h2>{" "}
          </div>{" "}
          <button
            onClick={() => {
            ...
            {autoCategorizeRules.map((rule) => (
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    {" "}
                    <h3 className="font-semibold text-slate-100"> "{rule.keyword}" </h3>{" "}
                    <span className="text-slate-500">→</span>{" "}
                    <span className="text-sm text-slate-300"> {categoryName(rule)} </span>{" "}
                    {!rule.enabled && (
                      <span className="rounded-full border border-slate-700 px-2 py-0.5 text-[11px] text-slate-500">
                        {" "}
                        Disabled{" "}
