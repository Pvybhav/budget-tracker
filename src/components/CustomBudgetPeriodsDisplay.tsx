    ...
    <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl space-y-4">
      ...
      <div className="bg-slate-800/50 p-4 rounded-lg">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div>
            {" "}
            <p className="text-xs text-slate-400 mb-1">Current Budget Period</p>{" "}
            <p className="text-2xl font-bold text-slate-100">{periodLabel}</p>{" "}
            {selectedStartDate !== 1 && (
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          ...
          <div className="bg-slate-700/50 p-3 rounded">
            {" "}
            <p className="text-xs text-slate-400 mb-1">Days Elapsed</p>{" "}
            <p className="text-lg font-semibold text-slate-200"> {daysElapsed} </p>{" "}
          </div>{" "}
          <div className="bg-slate-700/50 p-3 rounded">
            {" "}
            <p className="text-xs text-slate-400 mb-1">Days Remaining</p>{" "}
            <p className="text-lg font-semibold text-slate-200"> {daysRemaining} </p>{" "}
          </div>{" "}
        </div>{" "}
        {/* Progress bar */}{" "}
